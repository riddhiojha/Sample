...
//        self.frame=CGRectMake(del.window.frame.size.width/2-self.frame.size.width/2, del.window.frame.size.height/2-self.frame.size.height/2, self.frame.size.width, self.frame.size.height);
	}
